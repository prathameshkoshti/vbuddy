                    ...
                    <tr>
                        <td colspan=2>
                            ...
                            <div class=" card border-light mb-3 ">
                                <div class="card-header text-primary" style="text-align: center;font-size: 170%">Create Announcements<br><br>
                                    <div style="right:50%; font-size:230%"><a href=""><span class="glyphicon glyphicon-plus-sign"></span></a></div>
                                </div>
                            </div>
